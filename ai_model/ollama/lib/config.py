...
"""
    ...
    ignore_content = add_fingerprint_header(ignore_content, "ignore")
...
"""
    ...
    # Add fingerprint header
    rule_content = add_fingerprint_header(rule_content, "md")
...
def add_fingerprint_to_json(data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Returns:
        Data with _metadata field added
    """
    data["_metadata"] = {
        "generator": f"ollama-llm-setup.py v{INSTALLER_VERSION}",
        "timestamp": _get_utc_timestamp(),
        "warning": "DO NOT EDIT MANUALLY - This file is managed by ollama-llm-setup"
    }
    return data
...
def load_installation_manifest() -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        _logger.warning(f"Manifest file is corrupt or invalid JSON: {manifest_path}: {e}")
        return None
    except (OSError, IOError, PermissionError) as e:
        _logger.warning(f"Failed to read manifest file: {manifest_path}: {e}")
        return None
