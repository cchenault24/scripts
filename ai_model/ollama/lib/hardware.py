...
class HardwareInfo:
    ...
    def get_estimated_model_memory(self) -> float:
        ...
        Uses a fixed 40% reservation for OS/apps, leaving 60% for models.
        ...
        # Use fixed 40% reservation for OS/apps
        reserved_percent = 0.40
...
def get_apple_silicon_usable_ram(hw_info: HardwareInfo) -> Optional[float]:
    ...
    using a fixed 40% reservation for OS/apps.
...
def detect_hardware() -> HardwareInfo:
    ...
    # Calculate usable RAM using fixed 40% reservation
